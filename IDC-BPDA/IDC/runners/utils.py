...
from IDC.datasets.custom import CustomSingleDataset, CustomAlignedDataset, CustomInpaintingDataset
...
def get_dataset_proto(data_config):
    train_dataset = Registers.datasets[data_config.dataset_type](data_config, stage='train')
    val_dataset = Registers.datasets[data_config.dataset_type](data_config, stage='val')

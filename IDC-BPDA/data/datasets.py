...
def cifar10_dataset_sub(args, root, transform=None, num_sub=-1, data_seed=0):
    # if args.train:
    #     val_data = torchvision.datasets.CIFAR10(root=root, transform=transform, download=True, train=True)
    # else:
...
def cifar100_dataset_sub(args, root, transform=None, num_sub=-1, data_seed=0):
    # if args.train:
    #     val_data = torchvision.datasets.CIFAR10(root=root, transform=transform, download=True, train=True)
    # else:
    #     val_data = torchvision.datasets.CIFAR10(root=root, transform=transform, download=True, train=False)
